...
local function atualizarBotaoSubir()
	...
	botaoSubir.MouseButton1Click:Connect(function()
		...
		if not plataformaAtiva then
			...
			plataforma.Size = Vector3.new(300, 1, 300)
			...
			task.wait(0.2)
			character:SetPrimaryPartCFrame(CFrame.new(plataforma.Position + Vector3.new(0, 4, 0)))
...
-- Speed Hack real com RenderStepped
...
-- Super Pulo real com RenderStepped
